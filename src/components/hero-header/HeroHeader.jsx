    ...
    <section className='hero-header'>
      <div className='content'>
        <div className='hero-header__top'>
          ...
          <div className='hero-header__img-spice'>
        ...
        <div className='hero-header__bottom'>
          <div className='hero-header__box'>
            ...
            <div className='hero-header__text'>
              ...
              <p className='body-text hero-header__subtitle'>Lorem ipsum dolor sit amet, consectetur adipiscing<br/> elit. Neque congue arcu</p>
            </div>
          </div>
          <div className='hero-header__box'>
            <div className='hero-header__text'>
              <p className='body-text hero-header__subtitle'>Lorem ipsum dolor sit amet, consectetur<br/> adipiscing elit. Neque congue arcu</p>
            </div>
